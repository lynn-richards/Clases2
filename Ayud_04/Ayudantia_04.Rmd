...
reg <- params$reg
#google_places(search_string = "Drugstores in Santiago, Chile", key = AIzaSyAvGk7QD5cyhpT6T2Fz020c1deUfr1nhvU)
...
hospitales$NOM_COMUNA <- toupper(hospitales$NOM_COMUNA) # Modificamos nombre de la comuna, mayusculas
hospitales$NOMBRE <- toupper(hospitales$NOMBRE) # Modificamos nombre del hospital, mayusculas
...
#df es la base de datos, value es el fill,  joinBy es por comuna, name para el color
#hc_tooltip para la leyende a del  mapa, que es te el porcentaje 

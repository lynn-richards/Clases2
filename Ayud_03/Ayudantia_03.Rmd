...
var_sexo[,sexo_anterior := shift(V1, n = 1, type = 'lag'), by = .(sexo)] #Me crea una columna con los datos del mes anterior.
```
...
var_sexo_2 <- ts(var_sexo_2[, .(Hombres,Mujeres)],start = c(2019,3), end =c(2020,1),frequency = 12) #timeseries, transformar un objeto a ts, como data.table
```
